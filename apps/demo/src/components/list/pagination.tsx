      ...
      <ul className="flex items-center gap-1">
        ...
        <li>
          <button
            ...
            disabled={page <= 1}
            className="rounded-md px-3 py-1.5 text-gray-600 hover:bg-gray-100 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
        ...
        {pages.map((p, i) =>
          p === "…" ? (
            <li key={`ellipsis-${i}`} className="px-2 text-gray-400 select-none">
              …
            </li>
          ) : (
            <li key={p}>
